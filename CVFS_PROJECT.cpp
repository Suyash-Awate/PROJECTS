...
void DisplayHelp()
{
	...
	printf("read     : To read the contents fron file\n");
	...
	while(1)
	{
		...
		else if(count==3)
		{
			if(strcmp(command[0],"create")==0)
			{
				...
				if(ret>=0)
					printf("File is successfully created with fle descriptor : %d\n",ret);
				if(ret==-1)
					printf("ERROR : Incorrect parameters\n");
				if(ret==-2)
			...
			else if(strcmp(command[0],"open")==0)
			{
				...
				if(ret>=0)
					printf("File is successfully opened with fle descriptor : %d\n",ret);
				if(ret==-1)
					printf("ERROR : Incorrect parameters\n");
				if(ret==-2)
